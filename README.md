...
Este projeto tem como objetivo **coletar principais manchetes de portais estrangeiros**, **traduzir para português (pt-BR)** e **gerar resumos objetivos** utilizando o modelo **Gemini (Google AI)** de forma **gratuita via API pública**.
...
2. Crie um arquivo .env com as variáveis das chaves das APIs com os seguintes nomes: "NEWS_API_KEY" e "GEMINI_API_KEY"
3. Crie um ambiente virtual e faça a instalação do pacote de recursos descritos no requirements.txt
4. Execute o script em python selecionando na execução o tema das notícias desejadas para serem coletadas, traduzidas e resumidas
5. Acesse o resumo na pasta "data"